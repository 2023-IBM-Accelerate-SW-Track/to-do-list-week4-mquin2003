...
class AddTodo extends Component {
  ...
  handleSubmit = (event) => {
    ...
    if (this.state.content.trim()) {
      ...
      // Creating JSON object to be used as a body request for addItem function in express app
      ...
      // Making a POST request to the addItem function in express app and returning a response msg
